...
// this programs runs until we press RUNSTOP (semicolon on PC) or we enter any number character (0-9)
...
start:
    ...
    cmp #$30 // ascii numbers are hexa $30 to $39
    bcc start // if its lower then $30 we go back to start
    cmp #$3c  // now check if its greater or equal to $3c which comes after $39 (number 9)
