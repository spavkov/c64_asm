...
// https://codebase64.org/doku.php?id=base:rasterbars_source
...
main:    ldy #$5a         //load $7a into Y. this is the line where our rasterbar will start.
...
checkraster:
        ...
        bne checkraster  //is the value of Y not equal to current rasterposition? then jump back to check raster

        sta $d020        //if it IS equal, push the current value of A (a color of our rasterbar)
